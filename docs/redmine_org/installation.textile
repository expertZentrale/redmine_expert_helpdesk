...
*View AI statistics* is the one *global* permission — it is granted once to a role and then applies across all projects without project membership, because it exposes the token spend of the AI features.
