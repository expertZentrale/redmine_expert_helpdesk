  ...
  module ApiSerializers
    ...
    def project_setting(api, s, priorities = [])
      api.helpdesk_project_setting do
        ...
        # Guards on the attachment "block" button and the colours of the
        # customer-facing reply block; blank means the project inherits the
        # central value.
        api.blacklist_types         s.blacklist_types
        api.blacklist_max_kb        s.blacklist_max_kb
