...
| `info_request_threshold` | integer \| null | How many rules must fail before the customer is asked. Minimum 1 — `0` answers 422 (switch the check off via `info_request_mode` instead). |
